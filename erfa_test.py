...
## astrometry tools
    ...
    def test_apcg(self):
        ...
        self.assertAlmostEqual(astrom.v[0], 0.4289638913597693554e-4, places=16)
        self.assertAlmostEqual(astrom.v[1], 0.8115034051581320575e-4, places=16)
        self.assertAlmostEqual(astrom.v[2], 0.3517555136380563427e-4, places=16)
        self.assertAlmostEqual(astrom.bm1, 0.9999999951686012981, places=12)
        self.assertAlmostEqual(astrom.bpn[0][0], 1.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[1][0], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[2][0], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[0][1], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[1][1], 1.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[2][1], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[0][2], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[1][2], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[2][2], 1.0, 0.0)
    ...
    def test_apcg13(self):
        ...
        self.assertAlmostEqual(astrom.v[0], 0.4289638912941341125e-4, places=16)
        self.assertAlmostEqual(astrom.v[1], 0.8115034032405042132e-4, places=16)
        self.assertAlmostEqual(astrom.v[2], 0.3517555135536470279e-4, places=16)
        self.assertAlmostEqual(astrom.bm1, 0.9999999951686013142, places=12)
        self.assertAlmostEqual(astrom.bpn[0][0], 1.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[1][0], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[2][0], 0.0, 0.0)
        self.assertAlmostEqual(astrom.bpn[0][1], 0.0, 0.0)
    ...
    def test_apco(self):
        ...
        self.assertAlmostEqual(astrom.eb[0], -0.9741827110630322720, places=12)
        self.assertAlmostEqual(astrom.eb[1], -0.2115130190135344832, places=12)
        self.assertAlmostEqual(astrom.eb[2], -0.09179840186949532298, places=12)
        self.assertAlmostEqual(astrom.eh[0], -0.9736425571689739035, places=12)
        self.assertAlmostEqual(astrom.eh[1], -0.2092452125849330936, places=12)
        self.assertAlmostEqual(astrom.eh[2], -0.09075578152243272599, places=12)
        self.assertAlmostEqual(astrom.em, 0.9998233241709957653, places=12)
        self.assertAlmostEqual(astrom.v[0], 0.2078704992916728762e-4, places=16)
        self.assertAlmostEqual(astrom.v[1], -0.8955360107151952319e-4, places=16)
        self.assertAlmostEqual(astrom.v[2], -0.3863338994288951082e-4, places=16)
        self.assertAlmostEqual(astrom.bm1, 0.9999999950277561236, places=12)
        self.assertAlmostEqual(astrom.bpn[0][0], 0.9999991390295159156, places=12)
        self.assertAlmostEqual(astrom.bpn[1][0], 0.4978650072505016932e-7, places=12)
        self.assertAlmostEqual(astrom.bpn[2][0], 0.1312227200000000000e-2, places=12)
        self.assertAlmostEqual(astrom.bpn[0][1], -0.1136336653771609630e-7, places=12)
        ...
        self.assertAlmostEqual(astrom.diurab, 0, 0)
    ...
    def test_apco13(self):
        ...
        self.assertAlmostEqual(astrom.eb[0], -0.9741827107320875162, places=12)
        self.assertAlmostEqual(astrom.eb[1], -0.2115130190489716682, places=12)
        self.assertAlmostEqual(astrom.eb[2], -0.09179840189496755339, places=12)
        self.assertAlmostEqual(astrom.eh[0], -0.9736425572586935247, places=12)
        self.assertAlmostEqual(astrom.eh[1], -0.2092452121603336166, places=12)
        self.assertAlmostEqual(astrom.eh[2], -0.09075578153885665295, places=12)
        self.assertAlmostEqual(astrom.em, 0.9998233240913898141, places=12)
        self.assertAlmostEqual(astrom.v[0], 0.2078704994520489246e-4, places=16)
        self.assertAlmostEqual(astrom.v[1], -0.8955360133238868938e-4, places=16)
        self.assertAlmostEqual(astrom.v[2], -0.3863338993055887398e-4, places=16)
        self.assertAlmostEqual(astrom.bm1, 0.9999999950277561004, places=12)
    ...
    def test_apcs(self):
        ...
        self.assertAlmostEqual(astrom.pmt, 13.25248468622587269, places=11)
        self.assertAlmostEqual(astrom.eb[0], -0.9741827110629881886, places=12)
        self.assertAlmostEqual(astrom.eb[1], -0.2115130190136415986, places=12)
        self.assertAlmostEqual(astrom.eb[2], -0.09179840186954412099, places=12)
        self.assertAlmostEqual(astrom.eh[0], -0.9736425571689454706, places=12)
        self.assertAlmostEqual(astrom.eh[1], -0.2092452125850435930, places=12)
        self.assertAlmostEqual(astrom.eh[2], -0.09075578152248299218, places=12)
        self.assertAlmostEqual(astrom.em, 0.9998233241709796859, places=12)
        self.assertAlmostEqual(astrom.v[0], 0.2078704993282685510e-4, places=16)
        self.assertAlmostEqual(astrom.v[1], -0.8955360106989405683e-4, places=16)
        self.assertAlmostEqual(astrom.v[2], -0.3863338994289409097e-4, places=16)
        self.assertAlmostEqual(astrom.bm1, 0.9999999950277561237, places=12)
        self.assertAlmostEqual(astrom.bpn[0][0], 1, 0)
        self.assertAlmostEqual(astrom.bpn[1][0], 0, 0)
        self.assertAlmostEqual(astrom.bpn[2][0], 0, 0)
        self.assertAlmostEqual(astrom.bpn[0][1], 0, 0)
        self.assertAlmostEqual(astrom.bpn[1][1], 1, 0)
        self.assertAlmostEqual(astrom.bpn[2][1], 0, 0)
        self.assertAlmostEqual(astrom.bpn[0][2], 0, 0)
        self.assertAlmostEqual(astrom.bpn[1][2], 0, 0)
        self.assertAlmostEqual(astrom.bpn[2][2], 1, 0)
    ...
    def test_apcs13(self):
        ...
        self.assertAlmostEqual(astrom.pmt, 12.65133794027378508, places=11)
        self.assertAlmostEqual(astrom.eb[0], 0.9012691529025250644, places=12)
        self.assertAlmostEqual(astrom.eb[1], -0.4173999812023194317, places=12)
        self.assertAlmostEqual(astrom.eb[2], -0.1809906511146429670, places=12)
        self.assertAlmostEqual(astrom.eh[0], 0.8939939101760130792, places=12)
        self.assertAlmostEqual(astrom.eh[1], -0.4111053891734021478, places=12)
        self.assertAlmostEqual(astrom.eh[2], -0.1782336880636997374, places=12)
        self.assertAlmostEqual(astrom.em, 1.010428384373491095, places=12)
        self.assertAlmostEqual(astrom.v[0], 0.4279877294121697570e-4, places=16)
        self.assertAlmostEqual(astrom.v[1], 0.7963255087052120678e-4, places=16)
        self.assertAlmostEqual(astrom.v[2], 0.3517564013384691531e-4, places=16)
        self.assertAlmostEqual(astrom.bm1, 0.9999999952947980978, places=12)
        self.assertAlmostEqual(astrom.bpn[0][0], 1, 0)
        self.assertAlmostEqual(astrom.bpn[1][0], 0, 0)
        self.assertAlmostEqual(astrom.bpn[2][0], 0, 0)
        self.assertAlmostEqual(astrom.bpn[0][1], 0, 0)
    ...
    def test_pmsafe(self):
        ...
        self.assertAlmostEqual(dec2, 0.7888249982450468567, places=12)
        self.assertAlmostEqual(pmr2, 0.9996457663586073988e-5, places=12)
        self.assertAlmostEqual(pmd2, -0.2000040085106754565e-4, places=16)
        self.assertAlmostEqual(px2, 0.9999997295356830666e-2, places=12)
        self.assertAlmostEqual(rv2, 10.38468380293920069, places=10)
...
## astronomy library
    ...
    def test_pvstar(self):
        ...
        self.assertAlmostEqual(pmr, -0.1783235160000472788e-4, places=16,)
        self.assertAlmostEqual(pmd, 0.2336024047000619347e-5, places=16,)
        self.assertAlmostEqual(px, 0.74723, places=12,)
        self.assertAlmostEqual(rv, -21.60000010107306010, places=11,)
    ...
    def test_starpm(self):
        ...
        self.assertAlmostEqual(ra2, 0.01668919069414256149, places=13)
        self.assertAlmostEqual(dec2, -1.093966454217127897, places=13)
        self.assertAlmostEqual(pmr2, -0.1783662682153176524e-4, places=17)
        self.assertAlmostEqual(pmd2, 0.2338092915983989595e-5, places=17)
        self.assertAlmostEqual(px2, 0.7473533835317719243, places=13)
        self.assertAlmostEqual(rv2, -21.59905170476417175, places=11)
    ...
    def test_starpv(self):
        ...
        self.assertAlmostEqual(pv[1][0], -0.4051854008955659551e-2, places=13)
        self.assertAlmostEqual(pv[1][1], -0.6253919754414777970e-2, places=15)
        self.assertAlmostEqual(pv[1][2], 0.1189353714588109341e-1, places=13)
